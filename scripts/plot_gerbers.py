...
'''
    ...
    Stolen from Greg Davill and modified for my use.
    https://github.com/gregdavill/kicadScripts
...
output_directory = os.path.join(project_path,'gerbers')
